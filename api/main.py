...
async def lifespan(app: FastAPI):
    global _tracker_task, _price_checker_task, _portfolio_task, _daily_summary_task
    ...
    for task in (_tracker_task, _price_checker_task, _portfolio_task, _daily_summary_task):
